...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "Bitcoin, Ethereum, BNB Chain, XRP Ledger, Solana, and Base today.",
  },
  {
    question: "Do you check sanctions lists?",
    answer:
      "Yes, partially. We self-host the US Treasury's OFAC sanctions list and check every investigated wallet against it (Bitcoin, Ethereum, BNB Chain, XRP Ledger, and Solana directly; Base indirectly, since it shares Ethereum's address format). EU, UK, and UN sanctions lists aren't connected yet - see How It Works for exactly why. A \"no match\" result means \"not found on the OFAC list we checked,\" not \"cleared by every sanctions authority.\"",
  },
];
